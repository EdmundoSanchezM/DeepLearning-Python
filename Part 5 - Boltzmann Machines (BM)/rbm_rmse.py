# -*- coding: utf-8 -*-
"""
Created on Wed Jun  7 19:59:52 2023
...
"""
Nota: Usando el RMSE, nuestra MBR obtendría un error alrededor de 0.46. 
Pero, aunque parece similar, no se debe confundir el RMSE y la distancia promedio. 
Un RMSE de 0.46 no significa que la distancia promedio entre la predicción y la verdad 
del dataset sea 0.46. En modo aleatorio terminaríamos con un RMSE de alrededor 
de 0.72. Un error de 0.46 corresponde al 75% de la predicción exitosa.
"""